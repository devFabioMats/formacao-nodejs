...
async function playRaceEngine(character1, character2) {
    ...
    for (let round = 1; round <= 5; round++) {
        ...
        if (block === "CONFRONTO") {
            ...
            */
            //OTIMIZANDO IF's
            //se o poder do personagem 1 for maior que o poder do personagem 2 e os pontos do personagem 2 forem maiores que 0, então o personagem 2 perde 1 ponto
            character2.PONTOS -= powerResult1 > powerResult2 && character2.PONTOS > 0 ? 1 : 0;
            //se o poder do personagem 2 for maior que o poder do personagem 1 e os pontos do personagem 1 forem maiores que 0, então o personagem 1 perde 1 ponto
